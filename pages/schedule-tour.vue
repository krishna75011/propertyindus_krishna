...
appoType.value = localStorage.getItem("appoType");
localStorage.removeItem("formName");
localStorage.removeItem("pageName");
localStorage.removeItem("date");
localStorage.removeItem("time");
localStorage.removeItem("appoType");

function onSubmit() {
  const formdata = JSON.stringify({
    tour_type: appoType.value,
    name: fullName.value,
    email: email.value,
    phone: phone.value,
  ...
  axios
    .post("https://app.propertyindus.com/api/schedule-appoinment", formdata, {
      headers: {
